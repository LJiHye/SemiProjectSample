...
public class FragmentCamera extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mimgMemoCamera = view.findViewById(R.id.imgMemoCamera);
        mbtnMemoCamera = view.findViewById(R.id.btnMemoCamera);
        mbtnMemoCamera.setOnClickListener(new View.OnClickListener() {
            @Override
