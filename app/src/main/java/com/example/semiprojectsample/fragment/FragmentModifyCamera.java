...
public class FragmentModifyCamera extends Fragment {
    ...
    public ImageView mimgModifyCamera;
    public Button mbtnModifyCamera;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mimgModifyCamera = view.findViewById(R.id.imgModifyCamera);
        ...
        mbtnModifyCamera.setOnClickListener(new View.OnClickListener() {
            @Override
